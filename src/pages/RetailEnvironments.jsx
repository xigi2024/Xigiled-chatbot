...
const RetailEnvironments = () => {
  ...
  useEffect(() => {
    const smartFeaturesSection = getSectionData('retail_section5');
  ...
  const heroSection = getSectionData('retail_section1');
  const excellenceSection = getSectionData('retail_section2');
  const smartDisplaysSection = getSectionData('retail_section3');
  const smartFeaturesSection = getSectionData('retail_section4');
  const flexibleDisplaySection = getSectionData('retail_section6');
  const chooseXigiSection = getSectionData('retail_section7');
  const transformSection = getSectionData('retail_section8');

  return (
    <div className="min-h-screen flex flex-col bg-[#f8faff]">
      <Header />

      {/* Hero Section - Now using API data */}
      {heroSection && (
...
<section className="bg-white rounded-t-[2.5rem] md:rounded-t-[3rem] -mt-10 z-20 relative py-16 md:py-24">
  ...
  <div className="container mx-auto flex flex-col lg:grid lg:grid-cols-2 gap-10 items-center">
    ...
    <div className="w-full">
        ...
        <div className='container mx-auto'>
          ...
          <div className="text-center mb-10">
            <h2 className="text-[28px] md:text-[32px] lg:text-[40px] font-medium mb-3 font-['Poppins',sans-serif]">
              {smartDisplaysSection?.title || "Smart Displays for Retail"}
            </h2>
            <p className="text-gray-900 text-[17px] mx-auto font-['Montserrat',sans-serif] font-medium">
              {smartDisplaysSection?.description || "Enhancing retail environments with cutting-edge LED technology"}
            </p>
          </div>
        ...
        <section className="bg-white py-20">
          <div className="container mx-auto">
            ...
            <div className="bg-[#EDF3FF] text-sm md:text-base text-gray-800 px-6 py-4 rounded-md flex items-center gap-3 mt-10">
              ...
              <p>Suggestion: P5 to P10 is a suitable choice for retail applications.</p>
            </div>
          </div>
        </section>
      )}
          ...
          <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-700 text-base md:text-lg mb-8 max-w-xl">
                {flexibleDisplaySection.description || "Choose from a range of ready-to-install formats or build a custom setup to suit your retail space:"}
              </p>
          ...
          <div className="container mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-gray-900 text-[17px] mx-auto font-['Montserrat',sans-serif] font-medium max-w-2xl">
                {chooseXigiSection.description || "Trusted solutions for retail businesses"}
              </p>
            </div>
      ...
      {/* Ready to Transform Section - Now using API data */}
      {transformSection && (
            ...
            >
              ...
              <div className="relative z-10 h-full flex flex-col justify-center px-6 sm:px-10 max-w-xl">
                <h2 className="text-[28px] md:text-[32px] lg:text-[40px] font-medium text-white mb-4 leading-tight font-['Poppins',sans-serif]">
                  {transformSection.title || "Ready to Transform Your Retail Space?"}
                </h2>
                <p className="mb-6 text-[17px] md:text-[17px] font-medium text-white">
                  {transformSection.description || "With Xigi LED, you're not just getting displays – you're gaining a partner committed to enhancing retail experiences."}
                </p>
                <button 
...
export default RetailEnvironments;