...
const RetailEnvironments = () => {
  ...
  // Find sections by their section identifier
  const section1 = apiData.find(item => item.section === 'retail_section1');
  const section2 = apiData.find(item => item.section === 'retail_section2');
  const section3 = apiData.find(item => item.section === 'retail_section3');
  const section4 = apiData.find(item => item.section === 'retail_section4');
  const section5 = apiData.find(item => item.section === 'retail_section5');
  ...
  <div className="absolute inset-0 bg-[rgba(0,0,0,0.6)] flex items-center justify-center">
    <h1 className="text-4xl md:text-6xl font-semibold text-white text-center">
      ...
      {section4 && (
        <ShowcaseSlider showcaseData={section4.images} />
      )}
        ...
        <div className="space-y-5">
          <div className="relative h-[600px] rounded-xl overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 right-0 h-1/3 bg-gradient-to-t from-black/90 to-transparent">
              <div className="absolute bottom-4 left-4 text-white text-[18px] font-semibold">
  ...
  className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-6 py-3 rounded-xl text-base md:text-lg  transition-all duration-300 cursor-pointer"
>
  Contact Us
</button>
          </div>
