          ...
          <div className="w-full md:w-6/12 order-2 md:order-1">
            ...
            <div className="space-y-4">
              {features.map((feature, idx) => (
                <div
                  key={idx}
                  className={`p-3 rounded-xl transition-all cursor-pointer flex flex-col ${
                    activeIndex === idx
...
const serviceFeatures = [
  ...
  {
    icon: <BadgeDollarSign className="text-blue-600 w-6 h-6" />,
      ...
      <main className="flex-grow">
        ...
        <div className="relative h-screen w-full overflow-hidden">
          ...
          <div className="relative z-20 flex flex-col items-center justify-center h-full text-white text-center px-4">
            <h1 className="text-5xl md:text-6xl bg-gradient-to-r from-[#0000ff] via-white to-[#0000ff] bg-clip-text text-transparent font-bold py-2">
              Brighten Every Space
            </h1>
            <p className="mt-4 max-w-2xl text-lg md:text-[16px]">
            ...
            <button className="mt-6 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded font-semibold">
              Get Instant Quote
            </button>
          </div>
        </div>
        ...
        {/* Why Choose Section */}
        <section className="py-20 px-4 md:px-8 bg-gradient-to-r from-white via-white to-[#f8f9fc]">
          <div className="max-w-7xl mx-auto text-center">
            <h2 className="text-3xl md:text-[40px] font-bold mb-12 text-gray-900">Why Choose Xigi LED?</h2>
            <div className="grid md:grid-cols-3 gap-6">
              {serviceFeatures.map((feature, index) => (
                ...
                >
                  ...
                  <h3 className="font-semibold text-[22px] text-gray-900 mb-1">{feature.title}</h3>
        ...
        <section className="py-16 px-4 md:px-8 bg-white">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl md:text-[40px] font-bold mb-12 text-center text-gray-900">
              Our Complete Range
            </h2>
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="w-full md:w-9/12 flex flex-col gap-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="bg-gray-50 rounded-xl shadow-sm hover:shadow-md transition overflow-hidden">
                    <img 
                      src="/images/indoor-led-wall.jpg" 
                      alt="Indoor LED Wall"
                      className="w-full h-40 object-cover"
                    />
                    <div className="p-6">
                      <h3 className="text-xl font-semibold mb-2">Indoor LED Wall</h3>
                      <p className="text-gray-600 text-sm">Crystal-clear displays for retail, corporate, and control rooms</p>
                    </div>
                  </div>
                  
                  <div className="bg-gray-50 rounded-xl shadow-sm hover:shadow-md transition overflow-hidden">
                    <img 
                      src="/images/outdoor-led.jpg" 
                      alt="Outdoor LED Starter"
                      className="w-full h-40 object-cover"
                    />
                    <div className="p-6">
                      <h3 className="text-xl font-semibold mb-2">Outdoor LED Starter</h3>
                      <p className="text-gray-600 text-sm">Weatherproof displays for outdoor advertising</p>
                    </div>
                  </div>
                  
                  <div className="bg-gray-50 rounded-xl shadow-sm hover:shadow-md transition overflow-hidden">
                    <img 
                      src="/images/interactive-display.jpg" 
                      alt="Interactive LED Display"
                      className="w-full h-40 object-cover"
                    />
                    <div className="p-6">
                      <h3 className="text-xl font-semibold mb-2">Interactive LED Display</h3>
                      <p className="text-gray-600 text-sm">Touch-enabled displays for engaging experiences</p>
                    </div>
                  </div>
                </div>
                ...
                {/* Row 2 */}
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="bg-gray-50 rounded-xl shadow-sm hover:shadow-md transition overflow-hidden sm:col-span-2">
                    <img 
                      src="/images/led-standee.jpg" 
                      alt="LED Standee Displays"
                      className="w-full h-40 object-cover"
                    />
                    <div className="p-6">
                  ...
                  <div className="bg-gray-50 rounded-xl shadow-sm hover:shadow-md transition overflow-hidden">
                    <img 
                      src="/images/transparent-led.jpg" 
                      alt="Transparent LED"
                      className="w-full h-40 object-cover"
                    />
                    <div className="p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <div className="bg-gray-50 rounded-xl shadow-sm hover:shadow-md transition overflow-hidden sm:col-span-2">
                    <img 
                      src="/images/xigi-display.jpg" 
                      alt="Xigi LED Technology"
                      className="w-full h-40 object-cover"
                    />
                    <div className="p-6">
              ...
              <div className="w-full md:w-3/12 flex flex-col gap-4">
                <div className="bg-gray-50 rounded-xl shadow-sm hover:shadow-md transition overflow-hidden h-full">
                  <img 
