    ...
    <section className="bg-white py-20 md:py-16 lg:py-24 px-4 md:px-6 lg:px-10">
      <div className="container mx-auto">
        ...
        <div
          ...
          style={{ maxWidth: "1200px", width: "100%" }} // ✅ Responsive instead of fixed width
        >
...
const FlexibleFeaturesSection = ({ featuresData }) => {
  ...
  const organizeFeatures = (images) => {
    ...
    const curvedDesign = images.find(img => img.title === 'Curved Design') || images[0];
    const flexibleBending = images.find(img => img.title === 'Flexible Bending') || images[1];
    const seamlessIntegration = images.find(img => img.title === 'Seamless Integration') || images[2];
    const highResolution = images.find(img => img.title === 'High Resolution') || images[3];
    const customShapes = images.find(img => img.title === 'Custom Shapes') || images[4];
      ...
      <div className="container grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          <div className="relative rounded-xl overflow-hidden bg-[#1E2D3D] p-5 h-full flex flex-col justify-between shadow-lg h-[581px]">
            <img
              src={getImageUrl(features.curvedDesign.image)}
              alt={features.curvedDesign.title}
            ...
            <div>
              <h3 className="text-white text-xl font-bold mb-2">
                {features.curvedDesign.title}
              </h3>
              {features.curvedDesign.description && (
        ...
        <div className="space-y-6">
          <div className="relative rounded-xl overflow-hidden bg-[#1E2D3D] p-5 shadow-lg h-[250px]">
            <img
              src={getImageUrl(features.flexibleBending.image)}
              alt={features.flexibleBending.title}
            ...
            <div>
              <h3 className="text-white text-lg font-semibold">
                {features.flexibleBending.title}
              </h3>
              {features.flexibleBending.description && (
                <p className="text-white text-sm">
                  {features.flexibleBending.description}
                </p>
              )}
          ...
          <div className="relative rounded-xl overflow-hidden bg-[#1E2D3D] p-5 shadow-lg h-[307px]">
            <img
              src={getImageUrl(features.seamlessIntegration.image)}
              alt={features.seamlessIntegration.title}
            ...
            <div>
              <h3 className="text-white text-lg font-semibold">
                {features.seamlessIntegration.title}
              </h3>
              {features.seamlessIntegration.description && (
                <p className="text-white text-sm">
                  {features.seamlessIntegration.description}
                </p>
              )}
        ...
        <div className="space-y-6">
          <div className="relative rounded-xl overflow-hidden bg-[#1E2D3D] p-5 shadow-lg h-[307px]">
            <img
              src={getImageUrl(features.highResolution.image)}
              alt={features.highResolution.title}
            ...
            <div>
              <h3 className="text-white text-lg font-semibold">
                {features.highResolution.title}
              </h3>
              {features.highResolution.description && (
                <p className="text-white text-sm">
                  {features.highResolution.description}
                </p>
              )}
          ...
          <div className="relative rounded-xl overflow-hidden bg-[#1E2D3D] p-5 shadow-lg h-[250px]">
            <img
              src={getImageUrl(features.customShapes.image)}
              alt={features.customShapes.title}
            ...
            <div>
              <h3 className="text-white text-lg font-semibold">
                {features.customShapes.title}
              </h3>
              {features.customShapes.description && (
                <p className="text-white text-sm">
                  {features.customShapes.description}
                </p>
              )}
...
const FlexibleLed = () => {
  ...
  const transformInteriorsData = getSectionData('flexible_curved_wall_section1');
  ...
  const faqSection = getSectionData('flexible_curved_wall_faq_section');
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="relative h-[70vh] w-full">
        ...
        <span className="inline-flex items-center gap-2">
          ...
          <span>›</span>
          <span className="text-blue-600 text-decoration-none font-medium">Flexible & Curved LEDs  </span>
        </span>
      </div>
          ...
          <>
            ...
            <div className="lg:col-span-7 h-auto">
              <img
                ...
                alt={transformInteriorsData.title || "Flexible & Curved LED Wall"}
                className="w-full h-full rounded-xl md:h-[400px] drop-shadow-xl object-cover"
              />
            </div>
          </>
        ) : (
...
{/* Features Section */}
      ...
      <FlexibleFeaturesSection featuresData={featuresData} />
