...
const EventsExhibitions = () => {
  ...
  // Fixed section names to match the JSON data
    ...
    <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
      ...
      <div className="flex-1 text-left">
        <h1 className="text-[28px] md:text-[32px] lg:text-[40px] font-medium text-white mb-2 font-['Poppins',sans-serif]">
          {heroSection.title || "LED Displays for Events & Exhibitions"}
        </h1>

        <p className="text-[24px] md:text-[24px] lg:text-[18px] text-white mb-6 leading-tight">
          {heroSection.description || "At events and exhibitions, delivering clear and impactful communication is critical."}
        </p>
      </div>
          ...
          <div className="container mx-auto flex flex-col lg:grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="w-full">
              ...
              <p className="text-gray-700 text-base md:text-lg mb-6 leading-relaxed">
                {excellenceSection.description || "At events and exhibitions, delivering clear and impactful communication is critical. Your audience demands vivid visuals, seamless presentations, and reliable technology that performs flawlessly"}
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {chooseXigiSection.images?.map((item, index) => (
                ...
                >
                  ...
                  <div className="p-6">
                    <h3 className="font-semibold mb-3 group-hover:text-blue-700 transition-colors duration-300 text-center">
                      {item.title}
                    </h3>
                    {item.description && (
