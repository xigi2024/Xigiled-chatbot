...
const EventsExhibitions = () => {
  ...
  const [activeIndex, setActiveIndex] = useState(null); // Added missing state
  ...
  const faqSection = getSectionData('event_exhibition_faq_section');
...
<FAQSchema faqData={faqData.industry["events-and-exhibition"]} />
      ...
      {/* Banner Content Section (Below Banner) */}
      {heroSection && (
        <div className="container mx-auto px-4 md:px-8 lg:px-20 pb-12 pt-5 text-center">
          <h2 className="text-[28px] md:text-[32px] lg:text-[40px] font-medium mb-5 text-center text-gray-900 font-['Poppins',sans-serif]">
            {heroSection.title}
          </h2>
      ...
      <section className="bg-white rounded-t-[2.5rem] md:rounded-t-[3rem] -mt-10 z-20 relative py-16 md:py-20 lg:py-24">
        ...
        <div className="container mx-auto flex flex-col lg:grid lg:grid-cols-2 gap-10 ">
          ...
          <div className="w-full flex flex-col justify-center">
            ...
            <p className="text-dark text-[16px] mx-auto font-medium font-['Montserrat',sans-serif] leading-relaxed mb-6">
